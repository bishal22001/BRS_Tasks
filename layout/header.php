...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Bishal</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="aboutus.php">Excercise 1</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="contactus.php">Excercise 2</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="copy.html">Link2</a>
        </li>
